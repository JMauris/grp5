...
<body>
	<div style="height: 100%">
		...
		<div id="HikingListShowDiv">
			...
			</a> <a href="<?php echo URL_DIR.'programm/hiking_detail'?>">
				<button id="1">
					<p>Name</p>
					<p>Description..........................</p>
				</button>
		...
		<button id="HikingListButton">
			<img id="HikingListImage"
				src="http://localhost/cas_montana/public/img/search.png"
				onclick="window.location = 'search_path.php';"><?php echo $lang['BTN_SEARCH']; ?></button>
