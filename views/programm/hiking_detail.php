	...
	<div class="wrapper">
		...
		<table id="HikingDetailsTable">
			...
			<tr>
				...
				<td>
						...
						<FORM Method="post"
						action="<?php echo URL_DIR.'programm/saveNotice';?>">
		...
		<table style="width: 100%; text-align: center;">
			<tr>
				<td>
					<form method="post"
						action="<?php echo URL_DIR.'programm/saveFavoris';?>">
						<?php
...
if (isset ( $_SESSION ['personne'] ) && $_POST ['isInscri']) {
				?>
						<form method="post"
			action="<?php echo URL_DIR.'programm/removeRegister';?>">
			<table style="width: 100%; text-align: center;">
				<tr>
					<td><button id="submit1" style="width: 15%;" name="removeregister"
							value=<?php echo $SelectedTour->getId();?>><?php echo $lang['DISREGISTER']?></button></td>
				</tr>
			</table>
			...
			<table style="width: 100%; text-align: center;">
				<tr>
					<td><a href=" <?php echo URL_DIR."programm/programm_register" ?>">
			...
			<table style="width: 100%; text-align: center;">
				<tr>
					<td><a href="<?php echo $_SESSION['back']?>">
