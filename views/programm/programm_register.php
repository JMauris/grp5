...
<body>
	<div class="wrapper" style="height: 90%">
		...
		<form id="ProgrammRegisterForm" method="post"
			action="<?php echo URL_DIR.'programm/register_save';?>"
			onsubmit="alert('Saved')">
			<table style="align: center">
				<tr>
					<th><label for="name"><?php echo $lang['FIRSTNAME']; ?></label>* :
					</th>
...
if (isset ( $_SESSION ["personne"] )) {
				...
				<tr>
					<th><label for="lastname"><?php echo $lang['LASTNAME']; ?></label>*
						:</th>
...
if (isset ( $_SESSION ["personne"] )) {
				...
				<tr>
					<th><label for="locality"><?php echo $lang['LOCALITY']; ?></label>*
						:</th>
...
if (isset ( $_SESSION ["personne"] )) {
				...
				<tr>
					<th><label for="abonnement"><?php echo $lang['ABONEMENT']; ?></label>
						:</th>
					<th>
								<?php
								$optionAbo = array (
		...
		<div class="g-recaptcha"
			data-sitekey="6Lc43gkUAAAAAPsuLQ6YjIL5wYo5fi51_wcDLcOl"></div>
		<table style="width: 100%; text-align: center;">
			<tr>
				<td>
					<button id="submit1" style="width: 15%;" type="submit"
