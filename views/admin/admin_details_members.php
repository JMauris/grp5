							...
							<tr>
								...
								<td style="width: 2%;"> 
									<form action="<?php echo URL_DIR.'admin/update_member';?>" method= "post">
										<button  name ="selectedIDMember" value = <?php echo $cle;?> type = "submit"><?php echo $lang['BTN_EDIT']; ?></button>
									</form>
								</td>
							</tr>	
						<?php } ?>
							...
							<tr>
								...
								<td style="width: 2%;"> 
									<form action="<?php echo URL_DIR.'admin/deleteMember';?>" method= "post">
										<button  name ="selectedIDMember" value = <?php echo $memberArray[$cle]->getId();?> type = "submit"><?php echo $lang['BTN_DELETE']; ?></button>
									</form>
								</td>
							</tr>	
						<?php } ?>
