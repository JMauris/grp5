	...
	<div class="wrapper">
				...
				<tr>
					<td style="height: 100%;">
						<div id="show">
							...
							<form action="<?php echo URL_DIR.'search/search_detail'?>"
								method="post">
					 			...
					 			<?php if($tourResults == "error"){?>
					 				<h3><?php echo $lang['BLABLA']; ?></h3>
					 			 	<?php
										...
										<button name="selectedTour" style="width: 100%;"
									value=<?php echo $tourResults[$cle]->getId(); ?>>
		...
		<div id="SearchResultBottomDiv">
			<table id="SearchResultTable">
				<tr>
					<td id="SearchResultTd"><a
						href="<?php echo URL_DIR.'search/search_path'?>"><img
							id="SearchResultImage"
							src="<?php echo URL_DIR. 'public/img/searchRoute.png'?>"></a></td>
				</tr>
			</table>
		</div>
		<div class="push"></div>
