...
class Personne {
	 ...
	 */
	public function __construct($id = null, $firstname, $lastname, $email, $password = null, $idxLangue, $estActif, $numMember, $role, $portable, $phone, $adresse, $localite, $npa, $idxAbonnement) {
		$this->setId ( $id );
	...
	/**
	 * Method used for log in through email and pswd
	 *
	 * @param unknown $adressEmail        	
	 * @param unknown $pwd        	
	...
	public static function connect($adressEmail, $pwd) {
		...
		return new Personne ( $row ['idPersonne'], $row ['prenom'], $row ['nom'], $row ['email'], $row ['motDePasse'], $row ['idxLangue'], $row ['estActif'], $row ['numMembre'], $row ['role'], $row ['portable'], $row ['telephone'], $row ['adresse'], $row ['localite'], $row ['NPA'], $row ['idxAbonnement'] );
	}
	/**
	 * Method used to update persone by id
	 *
	 * @param unknown $id        	
	 * @return unknown
	 */
	...
	/**
	 * Method used for update password
	 *
	 * @param unknown $user        	
	 * @return unknown
	 */
	...
	/**
	 * Method that checks if person exists using email, name and lastname
	 *
	 * @param unknown $adressEmail        	
	 * @param unknown $name        	
	 * @param unknown $lastname        	
	...
	/**
	 * Method for creating a non cas user
	 *
	 * @param unknown $user        	
	...
	/**
	 * Method that retrives all Persone
	 *
	 * @return Personne
	 */
	public static function connectToAll() {
		...
		while ( $row = $result->fetch () ) {
			$resultArray [$row ['idPersonne']] = new Personne ( $row ['idPersonne'], $row ['prenom'], $row ['nom'], $row ['email'], $row ['motDePasse'], $row ['idxLangue'], $row ['estActif'], $row ['numMembre'], $row ['Localite'], $row ['portable'], $row ['telephone'], $row ['adresse'], $row ['Localite'], $row ['NPA'], $row ['idxAbonnement'] );
		}
	...
	/**
	 * Method that deletes Personne by id
	 * 
	 * @param unknown $id        	
	 * @return boolean
	 */
